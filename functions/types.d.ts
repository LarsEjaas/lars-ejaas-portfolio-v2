/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env --path=./functions/types.d.ts` (hash: 9a0a44678187cfd77be584c5cdccbaec)
// Runtime types generated with workerd@1.20260128.0 2026-01-31 enable_nodejs_process_v2,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		MAIL_USER: string;
		NOREPLY_PRIVATE_EMAIL_USER: string;
		PRIVATE_EMAIL_USER: string;
		NODE_ENV: string;
		SITE_URL: string;
		BLOCK_ALL_INDEXING: string;
		PUBLIC_PIWIK_SITE_ID: string;
		PUBLIC_PIWIK_TRACKER_URL: string;
		PUBLIC_PIWIK_DOMAINS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FACEBOOK_APP_ID" | "MAIL_PASSWORD" | "MAIL_USER" | "NOREPLY_PRIVATE_EMAIL_USER" | "PRIVATE_EMAIL_USER" | "NODE_ENV" | "SITE_URL" | "BLOCK_ALL_INDEXING" | "PUBLIC_PIWIK_SITE_ID" | "PUBLIC_PIWIK_TRACKER_URL" | "PUBLIC_PIWIK_DOMAINS" | "BLUESKY_HANDLE" | "BLUESKY_APP_PASSWORD" | "SERVERLESS_AUTH_TOKEN">> {}
}
