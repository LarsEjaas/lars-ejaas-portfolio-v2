export const work = {
  ...
  da: {
    ...
    friggtech_is_a_danish: 'Frigg Tech er en dansk virksomhed',
    ...
    accuranker_employment_description:
      'Ansvarlig for webudvikling af en SaaS webapplikation og hjemmeside.\n\nOpgaverne omfatter implementering af nye funktioner, løsning af fejl og refaktorering af ældre kode i applikationen.\n\nDesuden deltager du i forskellige webudviklingsprojekter for virksomhedens hjemmeside.',
