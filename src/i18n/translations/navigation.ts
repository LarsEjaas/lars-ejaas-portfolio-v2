export const navigation = {
  en: {
    ...
    the_page_you_are_looking_for:
      "The page you're searching for has either been relocated, deleted, renamed, or may have never existed.",
    go_back: 'Go Back',
    or: 'or',
    go_to_home: 'Go Home',
  ...
  da: {
    ...
    table_of_contents_title: 'Indholdsfortegnelse',
    toggle_toc: 'Vis/skjul indholdsfortegnelse',
